 ...
 * @author dinus
 */
public class User_manage_menu extends javax.swing.JInternalFrame {

    /**
     * Creates new form admin_user_manage
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/user/manageUser-06.png"))); // NOI18N
        ...
        jPanel1.add(jDesktopPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 200, 1300, 600));
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        try{
            ...
            while(rs.next())
            {
                if (user.equals(rs.getString(2)))
                {
                    if(user.equals(userid)){
                        ...
                        error_icon2.setText("You can not manage your accout go to your profile for settings");
                    }
                    else{
                    
                        System.out.println(userid);
                        errors();
                        User_manage.selectedUserid = user;
                        loopcheck = true;
                        User_manage view = new User_manage ();
            ...
            if(!loopcheck){
                error_icon.setVisible(true);
                error_icon2.setVisible(true);
                error_icon2.setText("No user found in system please check supplier id again");
