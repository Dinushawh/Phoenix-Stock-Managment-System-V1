 ...
 * @author dinus
 */
public final class Item_remove_menu extends javax.swing.JInternalFrame {

    /**
     * Creates new form item_remove_menu
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/ViewItems/remove-06.png"))); // NOI18N
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        try{
            ...
            while(rs.next())
            {
                ...
                {
                    errors();
                    Item_remove.productID = product_id;
//                    admin_supplier_view_fulldetails.userid = userid;
                    loopcheck = true;
                    Item_remove view = new Item_remove ();
