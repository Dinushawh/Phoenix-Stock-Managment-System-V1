 ...
 * @author dinus
 */
public class Supplier_view_menu extends javax.swing.JInternalFrame {

    /**
     * Creates new form supplier_view_menu
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/Suppliers/viewAll-06.png"))); // NOI18N
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        try{
            ...
            while(rs.next())
            {
                ...
                {
                    errors();
                    Supplier_view.supplierID = supplier_id;
//                    admin_supplier_view_fulldetails.userid = userid;
                    loopcheck = true;
                    Supplier_view view = new Supplier_view ();
