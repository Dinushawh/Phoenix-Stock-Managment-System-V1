 ...
 * @author dinus
 */
public class Item_update_menu extends javax.swing.JInternalFrame {

    /**
     * Creates new form item_update_menu
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/ViewItems/update-06.png"))); // NOI18N
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        try{
            ...
            while(rs.next())
            {
                ...
                {
                    errors();
                    Item_update.productID = product_id;
//                    admin_supplier_view_fulldetails.userid = userid;
                    loopcheck = true;
                    Item_update view = new Item_update ();
