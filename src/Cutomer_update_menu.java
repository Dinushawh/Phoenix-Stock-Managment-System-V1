 ...
 * @author dinus
 */
public final class Cutomer_update_menu extends javax.swing.JInternalFrame {

    /**
     * Creates new form cutomer_update_menu
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/Customer/update-06.png"))); // NOI18N
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try{
            ...
            while(rs.next())
            {
                ...
                {
                    errors();
                    Customer_update.customerid = customerID;
                    loopcheck = true;
                    Customer_update view = new Customer_update ();
