 ...
 * @author dinus
 */
public final class Invoice_update_menu extends javax.swing.JInternalFrame {

    /**
     * Creates new form invoice_update_menu
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/History/updateInvoice-06.png"))); // NOI18N
            ...
            while(rs.next())
            {
                if (invNo.equals(rs.getString(3)))
                {
                    ...
                    if("Reversed".equals(check)){
                        ...
                        errors();
                        Invoice_update.invoice_number = invNo;
                        Invoice_update.userid = userid;
                        loopcheck = true;
                        Invoice_update view = new Invoice_update ();
                        jDesktopPane1.removeAll();
                        jDesktopPane1.add(view).setVisible(true);
                    }
                }
