 ...
 * @author dinus
 */
public final class Cutomer_remove_menu extends javax.swing.JInternalFrame {

    /**
     * Creates new form cutomer_remove_menu
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/Customer/remove-06.png"))); // NOI18N
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try{
            ...
            while(rs.next())
            {
                ...
                {
                    errors();
                    Customer_remove.customerid = customerID;
                    loopcheck = true;
                    Customer_remove view = new Customer_remove ();
